...
function CreateDOMElements(mode){
    ...
    switch(mode){
        ...
        case "journal":
            ...
            iframe.contentDocument.body.innerHTML = "You need to give a name to your entry to save it. If you want to retrieve a saved entry then type the name of the entry in the text box";
            iframe.width = 750;
            iframe.height = 300;
            ...
            let icons = [createElement('i'),createElement('i'),createElement('i'),createElement('i'),createElement('i'),createElement('i'),createElement('i'),createElement('i')];
            mgBtn2.class('button');
            plBtn1.class('button');
            ...
            icons[2].class('fas fa-align-center');
            icons[3].class('fas fa-align-justify');
            icons[4].class('fas fa-align-left');
            icons[5].class('fas fa-align-right');
            ...
            icons[2].position(100,205);
            icons[3].position(125,205);
            icons[4].position(150,205);
            icons[5].position(175,205);
            icons[6].position(200,205);
            icons[7].position(225,205);
            ...
            icons[2].mouseClicked(execCmdAlignCenter);
            icons[3].mouseClicked(execCmdAlignJustify);
            icons[4].mouseClicked(execCmdAlignLeft);
            icons[5].mouseClicked(execCmdAlignRight);
